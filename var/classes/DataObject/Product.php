...
* @method static \Pimcore\Model\DataObject\Product\Listing getByBrands ($value, $limit = 0) 
...
public function setBrands ($Brands) {
	$this->Brands = $this->getClass()->getFieldDefinition("Brands")->preSetData($this, $Brands);
	return $this;
}
